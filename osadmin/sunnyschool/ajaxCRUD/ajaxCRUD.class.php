...
//    		echo "<script type=\"text/javascript\" src=\"http://ajax.aspnetcdn.com/ajax/jquery.validate/1.7/jquery.validate.min.js\"></script>\n"; 		//rel 6 - added ability to validate forms fields
                        echo "<script src=\"https://cdn.bootcss.com/jquery-validate/1.7.0/jquery.validate.min.js\"></script>\n";
                        //echo "<script type=\"text/javascript\" src=\"http://ajaxcrud.com/code/jquery.maskedinput.js\"></script>\n"; 	
                        echo "<script src=\"https://cdn.bootcss.com/jquery.maskedinput/1.3.1/jquery.maskedinput.js\"></script>";							//rel 6 - ability to mask fields (http://digitalbush.com/projects/masked-input-plugin/)
	...
	function showTable(){
        ...
        */
        ...
        if ($this->add){
            ...
            $add_html .= "<br />\n";
            $add_html .= "<table align='center' name='form' style='width:80%'>\n";
