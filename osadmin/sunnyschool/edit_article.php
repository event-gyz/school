...
$html.="<tr style='background-color:black'><td><font color='#fff'>標題</font></td><td><font color='#fff'>簡述</font></td><td><font color='#fff'>內文</font></td><td><font color='#fff'>標籤</font></td><td><font color='#fff'>類別</font></td><td><font color='#fff'>日期</font></td><td><font color='#fff'>動作</font></td></tr>";
$count = 0;
...
Template::assign('radio_options_val',array("NEWS","REC"));
Template::assign('radio_options_name',array("最新消息","推薦文章"));
Template::assign('type_filter_selected_val',$type);
Template::assign('tag_options_val',array("育儿","医疗","心理","教育"));
Template::assign('tag_options_name',array("育儿","医疗","心理","教育"));
Template::display ( 'sunnyschool/editArticle.tpl' );
	...
	$("input[name='edit_button']").click(function() {
    	...
    	$.ajax({
            ...
            success: function (jsonStr) {
	            ...
	            $("select[name='tag']").val(jsonStr.tag);
...
//	            $("textarea[name='content']").val($.base64.decode(jsonStr.content));
	            ...
	            $("select[name='type']").val(jsonStr.type);
