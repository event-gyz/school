...
$html.="<tr style='background-color:black'><td width='4%'><font color='#fff'>編號</font></td><td width='20%'><font color='#fff'>標題</font></td><td width='40%'><font color='#fff'>簡述</font></td><td><font color='#fff'>內文</font></td><td><font color='#fff'>分類</font></td><td><font color='#fff'>類別</font></td><td><font color='#fff'>日期</font></td><td><font color='#fff'>動作</font></td></tr>";
...
Template::display ( 'sunnyschool/editRec.tpl' );
...
//	            $("select[name='type']").val(jsonStr.type);
	...
	function update_article(e) {
		...
		var type = "REC";//$("select[name='type']").val();
