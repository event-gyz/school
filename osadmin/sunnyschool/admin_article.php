<?php
    ...
    ########################################################
    ##
    $tblTvqa = new ajaxCRUD("News and articles", "articles", "uid", "ajaxCRUD/");
?>
...
//    $tblTvqa->displayAddFormTop();
    ...
    /*
    $tblTvqa->displayAs("title", "問題");
    $tblTvqa->displayAs("image", "示意圖檔名");
    ...
    */
    ...
    $tblTvqa->setTextareaHeight('content', 100);
    /*
    ...
    */
    ...
    $tblTvqa->addOrderBy("ORDER BY uid DESC");
...
*/
    ...
    */
    $range = array('NEWS','REC');
    $tblTvqa->defineAllowableValues("type", $range);

    $range_tags = array('育兒','醫療','心理','教育');
    $tblTvqa->defineAllowableValues("type", $range_tags);
