<?php
	...
	query("SET @num=0");
	query("UPDATE teacher_classroom SET uid=(@num:=@num+1)");


    #this one line of code is how you implement the class
    ########################################################
    ##
    $tblTvqa = new ajaxCRUD("教室设计参考图", "teacher_classroom", "uid", "ajaxCRUD/");
?>
...
//    $tblTvqa->displayAddFormTop();
    ...
    $tblTvqa->displayAs("name", "名称");
    $tblTvqa->displayAs("preview", "预览");
    $tblTvqa->setAddFieldNote("preview","请将示意图等比缩放到10cm宽再上传, 谢谢。");
    $tblTvqa->displayAs("ai_zip", "AI包(zip)");
	#set the textarea height of the longer field (for editing/adding)
    #http://ajaxcrud.com/api/index.php?id=setTextareaHeight
    $tblTvqa->setTextareaHeight('name', 100);
    /*
...
//    $tblTvqa->addAjaxFilterBoxAllFields();
	...
	$tblTvqa->formatFieldWithFunction('name', 'makeWidth200');
	$tblTvqa->formatFieldWithFunction('preview', 'makeWidth200');
	$tblTvqa->formatFieldWithFunction('ai_zip', 'makeWidth300');
