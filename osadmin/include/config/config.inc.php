...
//define ( 'ADMIN_BASE', '/www/web/kidsdna/kidsdna_store/sunnyschool/osadmin/include');
...
//OSAdmin常量
//define ( 'ADMIN_URL' ,'http://117.121.55.228/osadmin');
define ( 'ADMIN_URL' ,'http://school.com/school/osadmin');
//define ( 'ADMIN_URL' ,'http://39.106.119.56:81/sunnyschool/osadmin');
define ( 'ADMIN_TITLE' ,'管理后台');
define ( 'COMPANY_NAME' ,'Sunny School');
...
$DATABASE_LIST[OSA_DB_ID] = array (
	...
	"username"=> 'root',
	"password"=>'admin',
//        "username"=> 'kidsdna_sunny',
//        "password"=>'kidsdna',
	"db_name"=>'sunny_school' );
...
//COOKIE加密密钥，建议修改
define( 'OSA_ENCRYPT_KEY','ajnka124Dajksa9Ssd!');
