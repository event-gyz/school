                    ...
                    <section class="artbox">
                        ...
                        <section class="lbox">
                            ...
                            <ul class="artbox_category">
                                <li>
                                    <a href="?t=0" id="tag1" <?php if($_tag==0) echo('style="font-family:arial;color:#75CC69;font-size:18px;"'); ?>>育儿</a>&nbsp;
                                </li>
                                <li>
                                    <a href="?t=1" id="tag2" <?php if($_tag==1) echo('style="font-family:arial;color:#75CC69;"'); ?>>医疗</a>&nbsp;
                                </li>
                                <li>
                                    <a href="?t=2" id="tag3" <?php if($_tag==2) echo('style="font-family:arial;color:#75CC69;"'); ?>>心理</a>&nbsp;
                                </li>
                                <li>
                                    <a href="?t=3" id="tag4" <?php if($_tag==3) echo('style="font-family:arial;color:#75CC69;"'); ?>>教育</a>
                                </li>
                            </ul>
                            <!--//文字編輯器區//-->
                        ...
                        <section class="rbox">
                            ...
                            <!--//其它推薦文章//-->
                            <section class="list02" style="overflow:auto;max-height:700px;margin-top:20px">
