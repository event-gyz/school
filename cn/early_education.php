...
<section id="wrap">
    ...
    <section id="content">
        ...
        <!--//主內容//-->
        <section class="indexcont early_education">
            <section class="inbox noBoxShadowPage">
                ...
                <div class="brand">
                    <img src="../content/epaper/images/brand.jpg" alt="">
                </div>
                <div class="early_education_module">
                    <div class="early_education_introduce">
                        <div class="introduce">
                            ...
                            <p>
                                <i></i>
                                <span>巴布豆家庭早教包通过科学的方式，汇集两岸育儿专家，全力打造的一套系统、专业的家庭 早教方案。</span>
                                <b></b>
                            </p>
                    ...
                    <div class="business_cooperation_introduce">
                        <div class="introduce">
                            ...
                            <p>
                                <i></i>
                                <span>BOBDOG巴布豆，国际知名卡通品牌，专注为儿童设计，致力科技研发；巴布豆家庭早教诚挚邀 请您,携手开展幼儿教 育广大商机！</span>
                                <b></b>
                            </p>
