...
Latest File Update: 2010-Jun-28
*/
define ('INCLUDED776',1);

$unset=array('logged_admin','isMod','user_id','langu','includeHeader','includeFooter', 'mod_rewrite', 'inss', 'insres','cook','archives');
...
$Tp_arc=$key.'_'.$Tp;
$Tt_arc=$key.'_'.$Tt;
$aff+=updateArray(array('poster_id'),$Tp_arc,'poster_id',$userID);
$aff+=updateArray(array('topic_poster'),$Tt_arc,'topic_poster',$userID);
}
